...
namespace CESAPSCOREWEBAPP.Controllers
{
    public class UniversitiesController : BaseController
    {
        ...
        public async Task<IActionResult> Create([Bind("UniversityId,UniversiryName")] University university)
        {
            /*Check Session */
            var page = "85";
            var typeofuser = "";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit([Bind("UniversityId,UniversiryName")] University university)
        {
            /*Check Session */
            var page = "86";
            var typeofuser = "";
        ...
        public async Task<IActionResult> remove(int id)
        {
            ...
            var university = await _context.Universities.FindAsync(id);
            var name = university.UniversiryName;
