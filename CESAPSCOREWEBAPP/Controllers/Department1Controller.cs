...
{
    [Authorize]
    public class Department1Controller : BaseController
    {
        private readonly DatabaseContext _context;

        public Department1Controller(DatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await _context.Department1s.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var department1 = await _context.Department1s
                .FirstOrDefaultAsync(m => m.Department1Id == id);
            if (department1 == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var department1 = await _context.Department1s.FindAsync(id);
            if (department1 == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> remove(int id)
        {
            ...
            var department1 = await _context.Department1s.FindAsync(id);
            var name = department1.Department1Name;

            _context.Department1s.Remove(department1);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.Department1s.Any(e => e.Department1Id == id);
        }
    }
}
