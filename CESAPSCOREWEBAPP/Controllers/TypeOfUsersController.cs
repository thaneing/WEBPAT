...
{
    [Authorize]
    public class TypeOfUsersController : BaseController
    {
        private readonly DatabaseContext _context;

        public TypeOfUsersController(DatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await _context.TypeOfUsers.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var typeOfUsers = await _context.TypeOfUsers
        ...
        {
            return _context.TypeOfUsers.Any(e => e.TypeOfUserId == id);
        }
    }
}
