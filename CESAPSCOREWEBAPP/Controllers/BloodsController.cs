...
{
    public class BloodsController : BaseController
    {
        private readonly DatabaseContext _context;

        public BloodsController(DatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await _context.Bloods.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("BloodId,BloodName")] Blood blood)
        {
            /*Check Session */
            var page = "90";
            var typeofuser = "";
